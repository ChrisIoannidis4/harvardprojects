...
def get_solution(node, target):
    # Function that gives a solution if node is the goal and we will us it in the shortest path
...
def shortest_path(source, target):
    ...
    # Search with loop until you find a solution
    while True:

        # If there's nothing left in the frontier, we have no solution
        if frontier.empty():
            return None
